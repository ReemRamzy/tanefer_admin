        ...
        <v-dialog persistent max-width="500" v-model="imageDialog">
          <v-card class="pa-5">
            ...
            <v-card-actions>
              ...
              <v-btn v-else tile color="success white--text" @click="updateCruise" :loading="updateCruiseLoading" :disabled="images.length === 0">ADD</v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
...
export default {
  ...
  methods: {
    ...
    updateCruise () {
      ...
      if (this.image) {
        formData.append('master_image', this.image, this.image.name)
      }
